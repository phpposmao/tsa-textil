...
import { CheckCircle, Play, FileChartColumn, Percent, ChartSpline, Handshake, MessageCircleMore, Facebook, Instagram, Linkedin } from "lucide-react"
...
export default function WebinarLandingPage() {
  ...
  return (
    <main className="bg-black bg-gradienteImgHome bg-cover bg-no-repeat text-white">
      {/* Form Popup */}
      ...
      <section className="py-16">
        <div className="max-w-[1000px] mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
            ...
            <span className="underline decoration-[#fc4c01]">vender mais</span>.
          </h1>
          ...
          <p className="text-sm mt-4 text-gray-300">
            (Você está a um clique de ficar à frente de 98% do marketing digital brasileiro)
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1000px] mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="w-full md:w-1/2">
              <Image
                src="/placeholder.svg?height=500&width=400&text=Alex+Torres"
                alt="Alex Torres"
                width={400}
                height={500}
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
              <div className="text-center">
                <div className="bg-gray-800 rounded-xl p-6 mb-4 flex items-center justify-center">
      ...
      <section className="py-16">
        <div className="max-w-[1000px] mx-auto px-4">
          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            <AccordionItem value="item-1" className="border border-gray-700 rounded-lg bg-gray-800">
            ...
            <AccordionItem value="item-2" className="border border-gray-700 rounded-lg bg-gray-800">
              <AccordionTrigger className="px-4 text-orange-500 hover:text-orange-600">
            ...
            <AccordionItem value="item-3" className="border border-gray-700 rounded-lg bg-gray-800">
              <AccordionTrigger className="px-4 text-orange-500 hover:text-orange-600">
            ...
            <AccordionItem value="item-4" className="border border-gray-700 rounded-lg bg-gray-800">
              <AccordionTrigger className="px-4 text-orange-500 hover:text-orange-600">
            ...
            <AccordionItem value="item-5" className="border border-gray-700 rounded-lg bg-gray-800">
              <AccordionTrigger className="px-4 text-orange-500 hover:text-orange-600">
      ...
      <section className="py-16">
        <div className="max-w-[1000px] mx-auto px-4 text-center">
          ...
          <div className="mt-4 flex items-center justify-center gap-2">
            ...
            <p className="text-sm">Quero me destacar agora!</p>
          </div>
        </div>
      </section>
    </main>
